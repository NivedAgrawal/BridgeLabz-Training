...
This repository contains my **Core Java practice work** done as part of **BridgeLabz training**.  
It includes Java fundamentals, problem-solving practice, and scenario-based implementations.
...
- Verified Java environment setup
- Solved basic Java programs  

🔗 [Programming Elements](https://github.com/NivedAgrawal/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/programming-elements)
...
- Completed **Level-1 & Level-2 problems**  
...
🔗 [Arrays](https://github.com/NivedAgrawal/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/arrays)  
...
### 📌 22-Dec-2025 (Monday)
- Studied **String class and string manipulation**
- Solved string-based problems
- **Completed and submitted String assignment**  

🔗 [Strings](https://github.com/NivedAgrawal/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/strings)
...
- Practiced advanced **String-based problems**
- Solved extra practice questions
...
## 📅 Week 3: Scenario-Based & Built-in Functions

### 📌 29-Dec-2025 (Monday)
- Studied **Employee Wage Computation problem**
- Solved scenario-based programs
- Practiced built-in Java functions
- **Completed and submitted assignments**  
...
## 🛠️ Technologies Used
### 2️⃣ [leet-code-codebase](https://github.com/NivedAgrawal/BridgeLabz-Training/tree/core-java-practice/leet-code-codebase)
Contains *1 Java problems* solved for:
- Logic building
